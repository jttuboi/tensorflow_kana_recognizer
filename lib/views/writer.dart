...
import 'package:tensorflow_kana_recognizer/views/all_stroke.provider.dart';
import 'package:tensorflow_kana_recognizer/views/border_painter.dart';
import 'package:tensorflow_kana_recognizer/views/current_stroke.provider.dart';
import 'package:tensorflow_kana_recognizer/views/message.provider.dart';
...
class Writer extends StatelessWidget {
  ...
  void _finishStroke(BuildContext context) {
    ...
    if (messageProvider.isTheLastStroke) {
      messageProvider.updateMessage().then((value) {
        allStrokeProvider.update();
      });
    }
  }
}
